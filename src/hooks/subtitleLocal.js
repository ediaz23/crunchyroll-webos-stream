...
import 'webostvjs'
import LibAss from 'libass-webos-legacy/legacy'
...
/** @type {LibAss} */
let libassObj = null
const LibassWorker = new URL('libass-webos-legacy/legacy/libass.worker.min.js', import.meta.url)
const LibassWorkerWasm = new URL('libass-webos-legacy/legacy/worker.min.js', import.meta.url)
